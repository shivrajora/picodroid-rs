...
| [designs/claudeusage-gaps-roadmap-2026-09.md](designs/claudeusage-gaps-roadmap-2026-09.md) | open | Platform defects (sim connect timeouts firing late on an unreachable host, LEFT_RIGHT gradients, `View.close()` leak) and UI gaps (font sizes, arc, charts, asset alpha, backlight PWM, BuildConfig, key dispatch) found building the `claudeusage` dashboard. |
