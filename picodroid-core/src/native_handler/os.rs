...
pub fn dispatch(
    ...
    match (class_name, method_name) {
        ("picodroid/os/SystemClock", m::sleep) => Some(crate::os::system_clock::sleep(ctx.args)),
        ("picodroid/os/SystemClock", m::elapsedRealtimeNanos) => {
            Some(crate::os::system_clock::elapsed_realtime_nanos())
        }
        ("picodroid/os/SystemClock", m::setCurrentTimeMillis) => {
        ...
        ("picodroid/content/pm/PackageManager", m::hasSystemFeature) => {
