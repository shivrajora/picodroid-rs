...
pub fn dispatch(
    ...
    match (class_name, method_name) {
        ...
        // ── ServerSocket ────────────────────────────────────────────────
        ("picodroid/net/ServerSocket", "nativeListen") => {
            Some(crate::net::server_socket::native_listen(ctx.args))
        }
        ...
        ("picodroid/net/DatagramSocket", "nativeCreate") => {
            Some(crate::net::datagram_socket::native_create(ctx.args))
        }
        ...
        ("picodroid/net/DatagramSocket", "receive") => Some(
            crate::net::datagram_socket::receive_native(ctx.args, ctx.objects, ctx.arrays),
        ),
        ("picodroid/net/DatagramSocket", "setTimeout") => Some(
            crate::net::datagram_socket::set_timeout_native(ctx.args, ctx.objects),
        ),
        ...
        ("picodroid/net/HttpURLConnection", "nativeConnect") => Some(
            crate::net::http_connection::native_connect(ctx.args, ctx.strings),
        ),
        ("picodroid/net/HttpURLConnection", "nativeReadResponseCode") => Some(
            crate::net::http_connection::native_read_response_code(ctx.args),
        ),
        ("picodroid/net/HttpURLConnection", "nativeContentLength") => {
            Some(crate::net::http_connection::native_content_length(ctx.args))
        }
        ...
        ("picodroid/net/HttpInputStream", "read") => Some(
            crate::net::http_connection::native_input_read(ctx.args, ctx.objects, ctx.arrays),
        ),

        // ── HttpOutputStream ────────────────────────────────────────────
        ("picodroid/net/HttpOutputStream", "write") => Some(
            crate::net::http_connection::native_output_write(ctx.args, ctx.objects, ctx.arrays),
        ),
