...
public class ProgressBar extends View {
  ...
  // than a checked no-op: every caller tests `indeterminate` first.
  private native void nativeSetProgress(int value, boolean animate);

  private native void nativeSetRange(int min, int max, int progress);
   ...
   */
  private native void nativeSetTint(int target, int argb, boolean apply);
