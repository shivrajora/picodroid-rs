...
class PicodroidPapkPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        ...
        // The active shrink map, when one applies: consumed by shrinkClasses and
        // handed to papk-pack so its entry-point check reads descriptors in
        // their shrunk spelling.
