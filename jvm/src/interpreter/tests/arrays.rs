...
// iconst_2, newarray 6, astore_1, aload_1, iconst_1, iconst_5, i2f, fastore,
// aload_1, iconst_1, faload, freturn  — method descriptor "()F" (0x46)
// code_length=13=0x0D, attr_len=25=0x19
#[rustfmt::skip]
static CLASS_FASTORE_FALOAD: &[u8] = &[
    // magic + version + cp_count=8
    0xCA, 0xFE, 0xBA, 0xBE, 0x00, 0x00, 0x00, 0x34, 0x00, 0x08,
    // #1 Class → #2
    0x07, 0x00, 0x02,
    // #2 Utf8 "T"
    0x01, 0x00, 0x01, 0x54,
    ...
    0x01, 0x00, 0x01, 0x6D,
    // #6 Utf8 "()F"
    0x01, 0x00, 0x03, 0x28, 0x29, 0x46,
    // #7 Utf8 "Code"
    0x01, 0x00, 0x04, 0x43, 0x6F, 0x64, 0x65,
    // access=1, this=#1, super=#3, 0 ifaces, 0 fields, 1 method
    0x00, 0x01, 0x00, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01,
    // method: flags=1, name=#5, desc=#6, 1 attr
    0x00, 0x01, 0x00, 0x05, 0x00, 0x06, 0x00, 0x01,
    // Code attr: name=#7, len=25, max_stack=3, max_locals=2, code_length=13
    0x00, 0x07, 0x00, 0x00, 0x00, 0x19,
    0x00, 0x03, 0x00, 0x02, 0x00, 0x00, 0x00, 0x0D,
    // code
    0x05,       // iconst_2
    0xBC, 0x06, // newarray float
    0x4C,       // astore_1
    0x2B,       // aload_1
    0x04,       // iconst_1
    0x08,       // iconst_5
    ...
    0x30,       // faload
    0xAE,       // freturn
    // exception_table_length=0, attrs_count=0, class attrs_count=0
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
];
...
#[test]
fn fastore_faload_roundtrip() {
    assert_eq!(run(CLASS_FASTORE_FALOAD).unwrap(), Some(Value::Float(5.0)));
}
