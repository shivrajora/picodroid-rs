...
pub(crate) fn dispatch(
    ...
    match method_name {
        ...
        m::min => match (ctx.args.first(), ctx.args.get(1)) {
        ...
        m::max => match (ctx.args.first(), ctx.args.get(1)) {
