...
The BME688 driver ([crates/picodroid-core/src/drivers/bme688/](https://github.com/shivrajora/picodroid-rs/tree/main/crates/picodroid-core/src/drivers/bme688/)) handles Bosch compensation. Read-only for now — calibration and heater-profile control are not exposed. The LTR559 driver lives at [crates/picodroid-core/src/drivers/ltr559.rs](https://github.com/shivrajora/picodroid-rs/blob/main/crates/picodroid-core/src/drivers/ltr559.rs) and exposes light (lux) plus raw proximity counts; gain and integration-time control are not yet exposed. See [Porting guide](/reference/porting-guide/#boardtoml-reference) for the full board.toml schema.
