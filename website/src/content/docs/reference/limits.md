...
| Storage volume | `fs_kb`: 512 KB (RP2350 boards), 128 KB (RP2040) | writes fail once LittleFS is full; every directory costs an 8 KB metadata pair; at boot every board removes the `/data/<package>` of any package not installed |
