---
title: "Licensing"
description: "Dual licensing: GPL-3.0-only for open use, proprietary for commercial."
---
...
1. **GPL-3.0-only** — the default open-source license. Free to use,
   ...
   [LICENSE](https://github.com/shivrajora/picodroid-rs/blob/main/LICENSE) for the full text.
...
BSD-2-Clause, BSD-3-Clause, MPL-2.0, or Apache-2.0). See [NOTICE](https://github.com/shivrajora/picodroid-rs/blob/main/NOTICE) for the full list and the
...
[Contributing](/project/contributing/) and [CLA](/project/cla/). The grant is
