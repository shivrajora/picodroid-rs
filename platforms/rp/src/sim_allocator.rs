...
/// Device heap arena size (FreeRTOS `configTOTAL_HEAP_SIZE`) for the chip
/// being simulated — the default heap cap. Must match
/// `platforms/rp/mcus/rp/FreeRTOSConfig.h` (a pre-commit cross-check guards
/// the pairing; see M2 in docs/parity-audit.md).
#[cfg(feature = "chip-rp2350")]
pub const DEVICE_HEAP_BYTES: usize = 416 * 1024;
#[cfg(not(feature = "chip-rp2350"))]
pub const DEVICE_HEAP_BYTES: usize = 128 * 1024;
