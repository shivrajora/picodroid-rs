...
//!
//! `picodroid_core::executors::background_pool` owns the work queue and
//! spawns the workers; this is the loop each one runs. It stays in the
//! platform crate for now because it reaches into the app's class loader and
//! shared heap, both of which move to `picodroid-core` at a later stage.
//!
...
use picodroid_core::executors::background_pool;
