...
pub(super) fn init(_spi_id: u8) {}

pub(super) fn reconfigure(_spi_id: u8, _freq_hz: u32, _mode: u32) {}
...
pub(super) fn write(spi_id: u8, _data_idx: u16, len: usize, _arrays: &ArrayHeap) -> i32 {
