...
pub(in crate::system::picodroid::graphics) fn set_items(id: i32, items: &str) {
    let mut buf = [0u8; 128];
...
pub(in crate::system::picodroid::graphics) fn get_selected(id: i32) -> i32 {
    unsafe { lv_dropdown_get_selected(handle_table::lookup(id)) as i32 }
}

pub(in crate::system::picodroid::graphics) fn perform_item_selected(id: i32) {
    unsafe {
        lv_obj_send_event(
